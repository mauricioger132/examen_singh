        ...
        @if(count($empleados) > 0)
            ...
            @foreach($empleados as $empleado )
                ...
                @if($empleado->estatus=='1') 
                    @php $acciones ='<div type="button" class="btn btn-danger btn-sm"  onclick="'.$parametros.'"><span><i class="fa fa-trash-alt" data-toggle="tooltip" data-placement="right" title="Eliminar activo" ></i></span></div>' @endphp
